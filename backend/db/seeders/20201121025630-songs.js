			...
			[
				{
					...
					artist: "invention_",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/snowstalgia.mp3",
					art: ["#1F487C", "#275564"],
					isPlaying: true,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Swørn",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/goingBack.mp3",
					art: ["#314F5A", "#575465"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Leavv",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/pavedPath.mp3",
					art: ["#2D6A63", "#DE9A66"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/bliss.mp3",
					art: ["#2A4878", "#E0828D"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/sleepover.mp3",
					art: ["#5E508E", "#926A92"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Sleepy Fish",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/restUntilDark.mp3",
					art: ["#1C6180", "#CEDDDC"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Sleepy Fish",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/colorsFade.mp3",
					art: ["#4090A7", "#E3CBAC"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Montell Fish",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/imagination.mp3",
					art: ["#C35173", "#F1C6B6"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Ezzy",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/ny90.mp3",
					art: ["#B15E66", "#569576"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Mo Anando",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/yesterday.mp3",
					art: ["#67CBC3", "#C47E7C"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "invention_",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/persist.mp3",
					art: ["#45598E", "#F598AD"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "No Spirit",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/letsStayInside.mp3",
					art: ["#467D60", "#C75043"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Sugi.wa",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/afterDark.mp3",
					art: ["#078E7F", "#C7FFD8"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Toonorth",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/farFromHome.mp3",
					art: ["#4D6D68", "#A0C497"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Sleepy Fish",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/nightsLikeThis.mp3",
					art: ["#045275", "#68C1D8"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Ward Wills",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/tsukisTears.mp3",
					art: ["#0C3C6D", "#DF7D82"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/motherNature.mp3",
					art: ["#342F49", "#E79AAF"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/myLoveForHer.mp3",
					art: ["#523A22", "#D19D6B"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Sleepy Fish",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/neverFeltTheSame.mp3",
					art: ["#301331", "#B55C62"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Sleepy Fish",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/velocities.mp3",
					art: ["#1E3C5B", "#92D1E2"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Moods, Yasper",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/sofaStories.mp3",
					art: ["#A55178", "#9DC694"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Miscél, Hanz",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/clouds.mp3",
					art: ["#00244B", "#D82526"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Kupla",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/tinySailboat.mp3",
					art: ["#3B1699", "#AF47A3"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/spaceCadet.mp3",
					art: ["#FF3B08", "#FED39E"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Strehlow",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/privateIsland.mp3",
					art: ["#982C36", "#F3A2A9"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "cocabona",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/6thStation.mp3",
					art: ["#1929EA", "#F282FE"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "weird inside",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/beAlright.mp3",
					art: ["#72494F", "#718363"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Yasper, Louk",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/hummusAndBread.mp3",
					art: ["#D74E2C", "#E2D5A1"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/finishLine.mp3",
					art: ["#EF9C1A", "#456282"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/fromTheTop.mp3",
					art: ["#182986", "#E55149"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Supertask",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/stagnant.mp3",
					art: ["#5E3B2E", "#E1B1A0"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/sundew.mp3",
					art: ["#403A92", "#EE8BD4"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/calm.mp3",
					art: ["#14277F", "#FEC8BD"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "xander.",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/warmFeeling.mp3",
					art: ["#693F3C", "#AB7174"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Psalm Trees",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/fiveYearsAgo.mp3",
					art: ["#1E2019", "#C62C2A"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Leavv",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/flushingStars.mp3",
					art: ["#4A6B56", "#CAD28B"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Aviino, Oliv",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/hotelLobby.mp3",
					art: ["#285AA1", "#B066B2"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/pineAndOak.mp3",
					art: ["#975B4E", "#43482D"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Tesk",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/burnMyMind.mp3",
					art: ["#6F69BB", "#A3DAED"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/neverEnding.mp3",
					art: ["#664232", "#6BCABC"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/paraglider.mp3",
					art: ["#D8724F", "#824544"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Clap Cotton",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/vinhoVerde.mp3",
					art: ["#465843", "#9EEEE1"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Miscél",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/needSomeone.mp3",
					art: ["#AA476D", "#F1C6E2"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					photo:
						"https://chillhop.com/wp-content/uploads/2020/07/6263175f6334ac348613790b863794010f2a9524-1024x1024.jpg",
					artist: "Delayde",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/littleSpirit.mp3",
					art: ["#4E2D7A", "#ECA4DE"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/hibiscus.mp3",
					art: ["#1E2F55", "#EABD44"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "xander.",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/cozyFire.mp3",
					art: ["#CE354A", "#596FB1"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "sadtoi",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/duBassin.mp3",
					art: ["#BF7448", "#EECFB4"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/flashesOfCalm.mp3",
					art: ["#2D0140", "#62C8F8"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Aviino",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/londonLoveLetters.mp3",
					art: ["#BFA250", "#C0CD4E"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "SwuM",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/aries.mp3",
					art: ["#49594A", "#D28A51"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/cruisin.mp3",
					art: ["#FC194A", "#41B3B3"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "weird inside",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/doingLaundry.mp3",
					art: ["#0C1382", "#3E8E84"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/oceanPatio.mp3",
					art: ["#713224", "#E24528"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "No Spirit",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/morningInTheCafe.mp3",
					art: ["#8C5A63", "#ECD3D7"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					artist: "Ian Ewing",
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/likeIam.mp3",
					art: ["#DE3868", "#663664"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
				},
				{
					...
					mp3: "https://s3.amazonaws.com/colour.ly/mp3/223.mp3",
					art: ["#6D8CBB", "#D87689"],
					isPlaying: false,
					createdAt: new Date(),
					updatedAt: new Date()
